---
title: 10.Screen mirroring
---

import useBaseUrl from "@docusaurus/useBaseUrl";

## 1. Screen mirroring method
...
## 3. The use of mobile phone screen mirroring software
...
### 3.2  Scan QR code to screen mirroring
...
## 4. The use of computer screen mirroring software
...
## 5. Apple device screen mirroring method

### 5.1  Airplay screen mirroring
...
### 5.2  Apple device software screen mirroring method
