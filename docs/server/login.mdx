---
title: 1. Smart Meeting Management Platform
---

import useBaseUrl from "@docusaurus/useBaseUrl";

## 13.1 How to register a new company

1.Go to the website login page：http://ihub.itc-pa.cn/#/login
...
## 13.2 How to create a meeting on the management platform
...
## 13.3 How to invite members to join
...
## 13.4 How can a regular member log in?
...
Alternatively, they can log in using the following website: http://ihub.itc-pa.cn/#/login . They need to enter their phone number and verification code obtained from the invitation link and click "Finish."
